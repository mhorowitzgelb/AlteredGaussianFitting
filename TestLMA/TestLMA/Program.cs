...
namespace TestLMA
{
    class Program
    {
        ...
        public class MultiTransitionAlteredGaussian : LMAFunction
        {
            ...
            private AlteredGaussian _alteredGaussian;
            ...
            public MultiTransitionAlteredGaussian(int transitions, double offsetLength, double[][] unAlterdData)
            {
                ...
                _alteredGaussian = new AlteredGaussian();
            ...
            public double GetY(double x, int transition, double[] a)
            {
                return _alteredGaussian.GetY(x,
            ...
            public override double GetY(double x, double[] a)
            {
                ...
                if (!unAlteredX.HasValue)
                    return 0;
                return _alteredGaussian.GetY(unAlteredX.Value, singleGaussianParams);
            }
            ...
            public override double GetPartialDerivative(double x, double[] a, int parameterIndex)
            {
                ...
                {
                    return _alteredGaussian.GetPartialDerivative(unAlteredX.Value, singleGaussianParams, 0);
                }
                else
                {
                    return _alteredGaussian.GetPartialDerivative(unAlteredX.Value, singleGaussianParams,
        ...
        class AlteredGaussian : LMAFunction
        {
            ...
            public override double GetY(double t, double[] param)
            {
                ...
                return (t>=(t0-sigma*sigma/mu)) ? ((Math.Exp(-(t - t0)*(t - t0)/(2*(sigma*sigma + mu*(t - t0))))*Math.Abs(A*sigma))/
